      ...
      <section className="grid grid-cols-2 h-[50vh]">
        <div className=" flex flex-col items-center justify-center gap-4">
          ...
          <div className="flex gap-3">
            <Link href="/generate"><button className="bg-purple-700 px-4 py-2 rounded-lg shadow-md font-bold text-white cursor-pointer hover:bg-purple-500 transition duration-300">Try Now</button></Link>
